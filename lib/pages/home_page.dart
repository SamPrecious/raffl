                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState == ConnectionState.done) {
                            if (snapshot.hasData) {
                              ...
                              List<ListingModel> recentlyViewedData = data[0];
                              int outputLength = recentlyViewedData.length;
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        children: recentlyViewedData.map((item) {
                                          String documentID = item.getDocumentID();
                                          String name = item.getName();
                                          int endDate = item.getDate();
                                          int ticketsSold = item.getTicketsSold();
                                          int usersInterested = item.getUsersInterested();
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        children: recommendedData.map((item) {
                                          String documentID = item.getDocumentID();
                                          String name = item.getName();
                                          int endDate = item.getDate();
                                          int ticketsSold = item.getTicketsSold();
